...
namespace E_Loan.BusinessLayer.Services
{
    public class LoanManagerServices : ILoanManagerServices
    {
        ...
        /// <summary>
        /// using this method accept loan application by manager before start the laon approval process
        /// </summary>
        ...
        /// loan status must be in "Accept" status, before sanction accept loan
        /// </summary>
